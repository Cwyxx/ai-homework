...
if __name__ == '__main__':
    ...
    batch_size = 32
    # train_epoch_num = 15
    model_load_path = "/data3/chenweiyan/aigc/detection-method/ckpt/ckpt_homework/model_best.pth"
    ...
    model_type_list = ["ADM", "BigGAN", "Glide", "Midjourney", "sd_1.4", "sd_1.5", "VQDM", "wukong"]
    # test-tensor
    for model_type in model_type_list:        
        print("Construct val dataset......")
        base_val_tensor_root = f"/data3/chenweiyan/dataset/aigc-detection-dataset/genimage/{model_type}/tensor-root/val"
        ...
        with torch.no_grad():
            y_true, y_pred = [], []
            for batch_tensor_1, batch_tensor_2, batch_label in tqdm(val_dataloader):
            ...
            print(f"Model: {model_type:<10}, Real Acc: {real_acc*100:.2f}, Fake Acc: {fake_acc*100:.2f}, Total Acc: {total_acc*100:.2f}")
